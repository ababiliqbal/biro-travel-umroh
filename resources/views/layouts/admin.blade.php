    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
                                ...
                                <ul role="list" class="-mx-2 space-y-1">
                                    <li>
                                        <a href="{{ route('admin.users.index') }}"
                                            class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition-all duration-200 {{ request()->is('admin/dashboard') ? 'bg-gray-800 text-white border-l-4 border-accent' : 'text-gray-400 hover:text-white hover:bg-gray-800' }}">
            ...
            <div
                ...
                <nav class="flex flex-1 flex-col">
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                        ...
                        <li>
                            <div class="text-xs font-semibold leading-6 text-gray-500 uppercase tracking-wider mb-2">
                                Manajemen</div>
                            <ul role="list" class="-mx-2 space-y-1">
                                <li>
                                    <a href="{{ route('admin.users.index') }}"
        ...
        <div class="flex flex-1 flex-col md:pl-72 transition-all duration-300">
            ...
            <div
                ...
                <button type="button" class="-m-2.5 p-2.5 text-gray-700 md:hidden hover:text-primary transition"
