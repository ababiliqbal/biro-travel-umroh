                            ...
                            @if (in_array(Auth::user()->role, ['admin', 'manager']))
                                <li>
                                    ...
                                    <ul role="list" class="-mx-2 space-y-1">
                                        ...
                                        <li>
                                            <a href="{{ route('admin.reports.late_payments') }}"
                                                class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition-all duration-200 {{ request()->routeIs('admin.reports.late_payments') ? 'bg-gray-800 text-white border-l-4 border-accent' : 'text-gray-400 hover:text-white hover:bg-gray-800' }}">
                                                <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
