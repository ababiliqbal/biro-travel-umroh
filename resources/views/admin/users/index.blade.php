                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <div
                                                class="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-sm border border-primary/20 ring-2 ring-transparent group-hover:ring-primary/20 transition-all">
                    ...
                    @forelse($users as $user)
                        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex flex-col gap-3">
                            <div class="flex items-start justify-between">
                                ...
                                @endphp
                                <span
                                    class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium ring-1 ring-inset {{ $badgeClass }} capitalize">
                                    {{ $user->role }}
                                </span>
                            </div>
